...
export const INVOICE_EVENT_TYPES = [
  ...
  },
  {
    ...
    direction: "inbound",
    description:
      "An inbound invoice has been received from an external system.",
  },
  {
...
export const WORKFLOW_ACTIONS = [
  {
    ...
    category: "outbound",
    description:
      "Process credit note by fetching original invoice and adapting it.",
  ...
  },
  {
    ...
    category: "outbound",
    description:
      "Validate the transformed invoice against FIRS schema and business rules.",
  ...
  },
  {
    ...
    category: "outbound",
    description:
      "Digitally sign the validated invoice using tenant FIRS credentials.",
  ...
  },
  {
    ...
    category: "outbound",
    description:
      "Execute the full outbound pipeline: Transform → Validate → Sign → Transmit in one call.",
...
export const referenceRoutes = new Elysia({ prefix: "/config/reference" })
  ...
  .get(
    "/events",
    ({ query }) => {
      let events: (typeof INVOICE_EVENT_TYPES)[number][] = [
        ...INVOICE_EVENT_TYPES,
      ];
