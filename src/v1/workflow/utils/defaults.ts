export const FIRS_INVOICE_METADATA= {
  "field_metadata": {
    ...
    "bill_party": {
      "required": false,
      "description": "optional (party object, just like accounting_customer_party)",
    ...
    "allowance_charge": {
      ...
      "charge_indicator_description": "indicates whether the amount is a charge (true) or an allowance (false)",
      "category": "financial"
    },
    "tax_total": {
      "required": false,
